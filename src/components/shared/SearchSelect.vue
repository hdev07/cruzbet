  ...
  <div ref="root" class="relative">
    ...
    >
      <ul
        v-if="isOpen"
        ref="listRef"
        class="app-scrollbar absolute z-20 mt-1 max-h-52 w-full origin-top overflow-y-auto rounded-xl border border-white/10 bg-mundial-dark py-1 shadow-xl shadow-black/40"
        role="listbox"
      >
        <li
