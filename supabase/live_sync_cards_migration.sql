-- Sincroniza tarjetas amarillas/rojas desde ESPN en apply_live_sync
...
revoke all on function public.apply_live_sync(uuid, text, integer, integer, integer, jsonb, text, text, jsonb) from public;
grant execute on function public.apply_live_sync(uuid, text, integer, integer, integer, jsonb, text, text, jsonb) to service_role;
