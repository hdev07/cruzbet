-- Migración: opción "No habrá goles" (predicted_minute = 0) y solo minuto exacto = 50 pts
...
begin
  ...
  -- Predicción: no habrá goles
  if pred_encoded = 0 then
    if goal_minute is null then return 50;
    return 0;
  end if;

  -- Predijo un minuto pero el partido terminó sin goles
